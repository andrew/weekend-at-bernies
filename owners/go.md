...
For the remediation taxonomy in [`../findings/README.md`](../findings/README.md), the go owner picture argues against per-package outreach for most cases. Many go bernies sit under archived corporate sub-orgs or under personal accounts whose attention has moved to other repos; the recommended action is usually to vendor the file (small libraries), switch to the version inside the new monorepo, or accept the pin. The 35 bernie-owners who also currently maintain an active critical go package, including the personal accounts of mitchellh, jackc and jinzhu, are the cases where adopt or switch outreach has somewhere to land, though contacting them about a five-year-old utility library is a different ask from contacting them about their current work.
